...
export default function ProfileCard({ username, currentLevel, levelProgressPercent }) {
  return (
    <div className="rounded-xl bg-emerald-600/90 px-6 py-5 flex flex-col sm:flex-row items-start sm:items-center gap-6 shadow-lg">
      ...
      <div className="flex flex-col gap-2 w-full sm:w-1/3">
        ...
        <div className="h-4 w-full rounded-full bg-black/40 overflow-hidden border border-black/30">
          <div className="h-full bg-emerald-300" style={{ width: `${levelProgressPercent}%` }} />
        </div>
      </div>
    </div>
  );
