...
export function AchievementHeader({ title, subtitle, className }) {
  return (
    <div className={cn('w-full rounded-xl bg-blue-600 text-white px-6 py-10 md:py-14 shadow relative overflow-hidden', className)}>
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-blue-50 max-w-2xl">{subtitle}</p>
      </div>
    </div>
  );
}
